...
class H_vmunet(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=1, layer_scale_init_value=1e-6, H_SS2D=H_SS2D, block=Block,
                 pretrained=None,
...
if __name__ == '__main__':
    ...
    model = H_vmunet(num_classes=1, input_channels=1).to('cuda')
    # out = our_model(img)
    # print(out.shape)
